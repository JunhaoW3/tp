...
| `* * *`  | user                   | add a new client's contact                                            | keep track of clients' information                                                                      |
| `* * *`  | user                   | delete a client's contact                                             | maintain a clean and relevant contact list                                                              |
...
| `* *`    | forgetful user         | be alerted when I try to add a duplicate client                       | avoid redundant records                                                                                 |
| `* *`    | user                   | edit a client's information                                           | reflect updated client information                                                                      |
...
| `*`      | user                   | see in-app tutorials                                                  | easily learng FinHub's features                                                                         |
